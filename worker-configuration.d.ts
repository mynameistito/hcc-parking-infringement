/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4dbdcabaa5ed9e3ce4ec532d452d1673)
// Runtime types generated with workerd@1.20260625.1 2026-01-01 nodejs_compat,web_socket_auto_reply_to_close
interface __BaseEnv_Env {
	...
	CRON_SECRET: string;
	WORKER_URL: string;
	PARKING_STORE: DurableObjectNamespace<import("./src/worker").ParkingStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ParkingStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HCC_API_BASE" | "API_KEY" | "CRON_SECRET" | "WORKER_URL">> {}
}
