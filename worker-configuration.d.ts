/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cdf54cd32022d237dd6260453171db2f)
// Runtime types generated with workerd@1.20260701.1 2026-06-25 nodejs_compat
interface __BaseEnv_Env {
	...
	CRON_SECRET: string;
	WORKER_URL: string;
	SEED_REFRESH_COORDINATOR: DurableObjectNamespace<import("./src/worker").SeedRefreshCoordinator>;
	SEED_REFRESH_WORKFLOW: Workflow<Parameters<import("./src/worker").SeedRefreshWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SeedRefreshCoordinator";
	}
